...
class ChapterReportDetailScreen extends ConsumerStatefulWidget {
  final String classroomId;
  final String classroomName;
  final String chapterId;
  final String chapterName;

  const ChapterReportDetailScreen({
    super.key,
  ...
  @override
  ConsumerState<ChapterReportDetailScreen> createState() =>
      _ChapterReportDetailScreenState();
}

class _ChapterReportDetailScreenState
    extends ConsumerState<ChapterReportDetailScreen> {
  @override
  Widget build(BuildContext context) {
    final reportAsync = ref.watch(chapterReportProvider(widget.chapterId));

    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(
        title: Text(
          'Báo cáo ${widget.chapterName}',
        ...
        error:
            (error, stack) => Center(
              child: EmptyStateWidgets.error(
                message: 'Không thể tải báo cáo chương học',
                onRetry: () {
                  ref.invalidate(chapterReportProvider(widget.chapterId));
                },
              ),
            ),
      ),
  ...
  Widget _buildContent(BuildContext context, ChapterReportDto report) {
  ...
  Widget _buildHeader(ChapterReportDto report) {
    return Card(
      elevation: 0,
  ...
  Widget _buildQuestionsList(ChapterReportDto report) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
