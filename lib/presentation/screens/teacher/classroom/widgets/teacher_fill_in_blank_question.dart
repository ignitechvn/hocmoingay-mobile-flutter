...
class TeacherFillInBlankQuestion extends StatelessWidget {
  final QuestionTeacherDto question;

  const TeacherFillInBlankQuestion({super.key, required this.question});
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Các từ cần điền sẽ được hiển thị ở đây',
                style: AppTextStyles.bodyMedium.copyWith(
